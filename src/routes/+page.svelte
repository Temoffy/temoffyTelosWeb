...
<ul>
    ...
    <li>stumbled across <a href="https://midnightsolarium.neocities.org/links">this neocities site</a> while googling neocities vs nekocities, very handy stuff here.</li>
    <li>One of the things I discovered through the above is the <a href="https://marginalia-search.com/">marginalia search engine</a> which I would normally ignore, BUT I decided to test it by searching for the old 4x game Stars! (yes, including exclamation) and it POPPED UP IN THE SUGGESTED SEARCHES LIST AS "stars! autohost"!! I may not use this a lot, but for obscure or older topic I might bring it to bear.</li>
</ul>
